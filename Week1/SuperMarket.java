...
public class SuperMarket
{
		public static void main(String args[])
	{
		...
		final String DAY_FOOTER = " Day Total "; // Leading spacesare intentional.
		final String SENTINEL = "done"; // Named constant forsentinel value.
		...
		while(done == false)
		{
			...
			if (prevDay.compareTo(dayOfWeek) == 0) {
				hoursTotal += hoursWorked;
			} else {
				System.out.println("Day total: " + hoursTotal);
				prevDay = dayOfWeek;
				hoursTotal = 0;
			}
